class StatusBar extends DrawObject {
    STATUS_IMG_OBJECT = {
        200: this.createImageForCache('../Sharkie/img/collect/green/Life/100_  copia 2.png'),
        160: this.createImageForCache('../Sharkie/img/collect/green/Life/80_  copia 3.png'),
        120: this.createImageForCache('../Sharkie/img/collect/green/Life/60_  copia 3.png'),
        80: this.createImageForCache('../Sharkie/img/collect/green/Life/40_  copia 3.png'),
        40: this.createImageForCache('../Sharkie/img/collect/green/Life/20_ copia 4.png'),
        0: this.createImageForCache('../Sharkie/img/collect/green/Life/0_  copia 3.png')
    };
    possibleStatusArray = [200, 160, 120, 80, 40, 0];
